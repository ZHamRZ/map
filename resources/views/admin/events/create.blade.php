...
@section('title', 'Tambah Acara Budaya')

@section('content')
<h4 class="mb-4">Tambah Acara / Festival Budaya</h4>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <select name="category" class="form-select @error('category') is-invalid @enderror">
                ...
                <option value="Pertunjukan" {{ old('category')=='Pertunjukan' ? 'selected' : '' }}>Pertunjukan</option>
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="location" class="form-control @error('location') is-invalid @enderror"
                   value="{{ old('location') }}" maxlength="255" placeholder="Mis: Halaman Kantor Desa">
        ...
        <div class="col-md-4">
            ...
            <input type="number" step="any" name="latitude" id="input-lat"
                   ...
                   value="{{ old('latitude') }}" readonly placeholder="Klik peta untuk memilih">
        ...
        <div class="col-md-4">
            ...
            <input type="number" step="any" name="longitude" id="input-lng"
                   ...
                   value="{{ old('longitude') }}" readonly placeholder="Klik peta untuk memilih">
